...
fr_spawn <- modifyList(DSMhabitat::fr_spawn, list("r_to_r_baseline" = r_to_r_baseline_fr_spawn))
...
# Save as data object to DSMhabitat
fr_juv <- modifyList(DSMhabitat::fr_juv, list("r_to_r_baseline" = r_to_r_baseline_fr_juv))
usethis::use_data(fr_juv, overwrite = TRUE)

# Save as data object to DSMhabitat
fr_fry <- modifyList(DSMhabitat::fr_fry, list("r_to_r_baseline" = r_to_r_baseline_fr_fry))
...
# Save as data object to DSMhabitat
fr_fp <- modifyList(DSMhabitat::fr_fp, list("r_to_r_baseline" = r_to_r_baseline_fr_fp))
...
# Save as data object to DSMhabitat
sr_spawn <- modifyList(DSMhabitat::sr_spawn, list("r_to_r_baseline" = r_to_r_baseline_sr_spawn))
...
# Save as data object to DSMhabitat
sr_juv <- modifyList(DSMhabitat::sr_juv, list("r_to_r_baseline" = r_to_r_baseline_sr_juv))
usethis::use_data(sr_juv, overwrite = TRUE)

# Save as data object to DSMhabitat
sr_fry <- modifyList(DSMhabitat::sr_fry, list("r_to_r_baseline" = r_to_r_baseline_sr_fry))
...
# Save as data object to DSMhabitat
sr_fp <- modifyList(DSMhabitat::sr_fp, list("r_to_r_baseline" = r_to_r_baseline_sr_fp))
...
# Save as data object to DSMhabitat
wr_spawn <- modifyList(DSMhabitat::wr_spawn, list("r_to_r_baseline" = r_to_r_baseline_wr_spawn))
...
# Save as data object to DSMhabitat
wr_juv <- modifyList(DSMhabitat::wr_juv, list("r_to_r_baseline" = r_to_r_baseline_wr_juv))
usethis::use_data(wr_juv, overwrite = TRUE)

# Save as data object to DSMhabitat
wr_fry <- modifyList(DSMhabitat::wr_fry, list("r_to_r_baseline" = r_to_r_baseline_wr_fry))
...
# Save as data object to DSMhabitat
wr_fp <- modifyList(DSMhabitat::wr_fp, list("r_to_r_baseline" = r_to_r_baseline_wr_fp))
