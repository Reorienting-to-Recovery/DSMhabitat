...
# add habitats together 
sr_fry <- c(DSMhabitat::sr_fry, r_to_r_baseline = list(DSMhabitat::sr_fry$biop_itp_2018_2019))

r_to_r_add_sj_sr_fry <- sr_fry$r_to_r_baseline
new_fry_hab <- sr_fry$r_to_r_baseline['San Joaquin River', , ] + hab['San Joaquin River', , ]
