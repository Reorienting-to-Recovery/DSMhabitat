...
spawning_moke <- read_excel('data-raw/watershed/mokelumne/data/archive/LMR_habitat__s_v2mw_to_MT.xlsx', 
...
rearing1 <- read_excel('data-raw/watershed/mokelumne/data/archive/LMR_habitat__s_v2mw_to_MT.xlsx', 
                       sheet = 'Instream WUA', range = 'A2:C8') 
rearing2 <- read_excel('data-raw/watershed/mokelumne/data/archive/LMR_habitat__s_v2mw_to_MT.xlsx', 
                       sheet = 'Instream WUA', range = 'A11:C14')
rearing3 <- read_excel('data-raw/watershed/mokelumne/data/archive/LMR_habitat__s_v2mw_to_MT.xlsx', 
...
mokelumne_river_floodplain <- read_excel('data-raw/watershed/mokelumne/data/archive/LMR_habitat__s_v2mw_to_MT.xlsx', 
