...
yuba_fp_new <- read_excel("data-raw/watershed/yuba/data/HydraulicHabFlow_LYR_7-15-2024.xlsx",
  ...
  # TODO confirm we can just add together? 
  mutate(FR_floodplain_acres = below_dpd + above_dpd,
         watershed = "Yuba River") |>
  select(-c(below_dpd, above_dpd))
...
yuba_river_floodplain <- left_join(yuba_fp_new, yuba_fp)
