...
salmonid_extents <- readOGR("../data-raw/rearing_spatial_data/salmonid_habitat_extents_updated/salmonid_habitat_extents.shp", 
...
leaflet() %>% 
      ...
      addPolylines(data = spr, group = 'Spring Run Rearing', label = make_label(spr),
                   color = '#5e3c99', opacity = .8, weight = 3) %>% 
      addPolylines(data = sps, group = 'Spring Run Spawning', label = make_label(spr),
                   color = '#e66101', opacity = 1, weight = 3) %>% 
