...
**Objective 1:** Is it possible to use a coarse estimate of gradient by dividing the reach length by the maximum and minimum elevation difference?
...
coarse_elevations <- data.frame('subbasin' = c("NY", "MY"), 
  ...
  mutate(length_ft = upstream_rm * 5280,
         ...
         channel_gradient = ifelse(gradient < 1, "0-1%",
                                    ifelse(gradient > 1 & gradient < 2, "1–2%",
                                           ifelse(gradient > 2 & gradient < 4, "2–4%",
                                                  ifelse(gradient > 4 & gradient < 8, "4–8%",
                                                         ifelse(gradient > 8, "8-12%",
                                                                "uhoh"))))))
...
knitr::kable(gradient_summary_table, caption = "The channel gradients determined through the coarse and fine scale approach for the Middle and North Yuba River")
```
...
knitr::kable(total_in_channel_rearing, caption = "in channel rearing % suitable based on gradient study in the Yuba River", digits = 1)
