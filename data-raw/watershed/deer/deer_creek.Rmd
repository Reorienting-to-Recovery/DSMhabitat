...
Suitable ranges for Deer Creek were obtained using the following proxies:

* Fall Run & Late-Fall Run Spawning - Clear Creek Fall Run (Gard 2019)
* All Species Juvenile Instream Rearing - Clear Creek Fall Run (Gard 2019)
* All Species Juvenile Floodplain Rearing - CBEC 2019
* Fall, Spring & Late-Fall Fry Rearing - Battle Creek Fall Run (Gard 2019)
* Steelhead Fry Rearing - Battle Creek Steelhead (Gard 2019)

Gard (2019) proxy data can be found [here](https://cvpia-documents.s3.us-west-1.amazonaws.com/HSC.xlsx)
...
spawn_table <- deer_creek_instream %>% select(contains("spawn"))
rearing_table <- deer_creek_instream %>% select(contains(c("juv","fry")))
```
