...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
# floodplain
va_fp_pre <- DSMhabitat::fr_fp$lto_12a["American River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
  ...
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm") |> 
  bind_rows(DSMhabitat::fr_fp$lto_12a["Feather River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb, 
  ...
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_fp$lto_12a["Mokelumne River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
  ...
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_fp$lto_12a["Yuba River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "Yuba River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_fp$lto_12a["Tuolumne River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
# spawning
va_spawn_pre <- DSMhabitat::fr_spawn$lto_12a["American River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "American River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm") |> 
  bind_rows(DSMhabitat::fr_spawn$lto_12a["Feather River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb, 
         stream = "Feather River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_spawn$lto_12a["Mokelumne River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "Mokelumne River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_spawn$lto_12a["Yuba River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "Yuba River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_spawn$lto_12a["Tuolumne River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "Tuolumne River") |> 
  pivot_longer(`1980`:`2000`,
...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
# inchannel
va_rear_pre <- DSMhabitat::fr_juv$lto_12a["American River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "American River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm") |> 
  bind_rows(DSMhabitat::fr_juv$lto_12a["Feather River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb, 
         stream = "Feather River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_juv$lto_12a["Mokelumne River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "Mokelumne River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_juv$lto_12a["Yuba River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "Yuba River") |> 
  pivot_longer(`1980`:`2000`,
               names_to = "year",
               values_to = "sqm")) |> 
  bind_rows(DSMhabitat::fr_juv$lto_12a["Tuolumne River",,] |> 
  as_tibble() |> 
  mutate(month = month.abb,
         stream = "Tuolumne River") |> 
  pivot_longer(`1980`:`2000`,
...
va_sutter_habitat_pre |> 
  ...
  labs(x = "Model date",
       ...
       title = "Sutter Basin floodplain habitat")
