...
# TODO - add lengths to vignette documentation and gitbook site 
# lower length - 45.7 miles
# upper length - 153 miles 
...
spawn <- expand_grid(
  ...
  mutate(
    biop_itp_2018_2019 = as.vector(DSMhabitat::sr_spawn$biop_itp_2018_2019['San Joaquin River' , , ] |> 
                         DSMhabitat::square_meters_to_acres()),
    r_to_r_baseline = as.vector(sr_spawn$r_to_r_baseline['San Joaquin River', , ]) |>  
      DSMhabitat::square_meters_to_acres()
    )

spawn |> 
  transmute(watershed, date = ymd(paste(year, month, 1)), 
            biop_itp_2018_2019, r_to_r_baseline) |> 
...
floodplain <- expand_grid(
  ...
  arrange(year, month, watershed) |> 
  mutate(
    biop_itp_2018_2019 = as.vector(DSMhabitat::sr_fp$biop_itp_2018_2019['San Joaquin River' , , ] |> 
                         DSMhabitat::square_meters_to_acres()),
    r_to_r_baseline = as.vector(sr_fp$r_to_r_baseline['San Joaquin River', , ]) |>  
      DSMhabitat::square_meters_to_acres()
    )
...
juv <- expand_grid(
  ...
  arrange(year, month, watershed) |> 
  mutate(
    biop_itp_2018_2019 = as.vector(DSMhabitat::sr_juv$biop_itp_2018_2019['San Joaquin River' , , ] |> 
                         DSMhabitat::square_meters_to_acres()),
    r_to_r_baseline = as.vector(sr_juv$r_to_r_baseline['San Joaquin River', , ]) |>  
      DSMhabitat::square_meters_to_acres()
    )
...
fry <- expand_grid(
  ...
  arrange(year, month, watershed) |> 
  mutate(
    biop_itp_2018_2019 = as.vector(DSMhabitat::sr_fry$biop_itp_2018_2019['San Joaquin River' , , ] |> 
                         DSMhabitat::square_meters_to_acres()),
    r_to_r_baseline = as.vector(sr_fry$r_to_r_baseline['San Joaquin River', , ]) |>  
      DSMhabitat::square_meters_to_acres()
    )
