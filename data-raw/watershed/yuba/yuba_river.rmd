...
- Delineation of in-channel and floodplain based on 1,5000 cfs wetted extent below DPD (as modified by HAllwood As-Built condition) and 1,750 cfs wetted extent above DPD
...
#### Fall run
Updated data from Morgan Neal (HDR Inc)
...
yuba_fp_new <- read_excel("data-raw/watershed/yuba/data/HydraulicHabFlow_LYR_7-15-2024.xlsx",
                              sheet = "LYR_HabFlowRelationships",
                              range = "A4:G40") |> 
    janitor::clean_names() |> 
  ...
  mutate(watershed = "Yuba River") |> glimpse()
...
threshold <- yuba_fp_new$flow_cfs[min(which(yuba_fp_new$FR_floodplain_acres > 0) - 1)]
