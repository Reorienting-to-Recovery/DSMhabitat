...
wetted_area_acres <- DSMhabitat::fr_wetted_channel_area %>% 
  filter(watershed == "Cottonwood Creek") %>% 
  pull(channel_area_of_FR_rearing_extent)

# TODO check with mark using gard estimate
