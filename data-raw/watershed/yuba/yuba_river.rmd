...
#### Chinook
Instream spawning and rearing habitat data provided for Chinook are provided in units of suitable acres. They were converted to square meters.
...
chinook_fp_rear <- read_excel("data-raw/watershed/yuba/data/HydraulicHabFlow_LYR_7-15-2024.xlsx",
                   sheet = "LYR_HabFlowRelationships",
                   range = "A4:G40") |> 
  janitor::clean_names() |> 
  select(flow_cfs, below_dpd = below_dpd_6, above_dpd = above_dpd_7) |> 
  pivot_longer(below_dpd:above_dpd, 
               names_to = "reach",
               values_to = "FR_fp_juv")
...
rearing <- eng_dag_approx %>% 
  ...
  select(flow_cfs, ST_fry_wua, ST_juv_wua, ST_spawn_wua)
        #FR_spawn_wua, SR_spawn_wua, 
        #FR_fry_wua, FR_juv_wua)
...
yuba_river_instream <- rearing %>% 
  ...
  select(flow_cfs, ST_spawn_wua, ST_fry_wua, ST_juv_wua, ST_adult_wua, watershed)
        # FR_spawn_wua, FR_fry_wua, FR_juv_wua, SR_spawn_wua)
