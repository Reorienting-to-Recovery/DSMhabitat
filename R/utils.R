...
get_habitat_selector <- function(species_wuas, species, life_stage, mode = "wua") {
  ...
  if (mode == "wua") {
    ...
    combos <- switch(species_lifestage,
                     WR_spawn = c("WR_spawn_hsi", "FR_spawn_hsi", "SR_spawn_hsi", 
                                  "ST_spawn_hsi"),
                     SR_spawn = c("SR_spawn_hsi", "FR_spawn_hsi", "ST_spawn_hsi"),
                     FR_spawn = c("FR_spawn_hsi", "SR_spawn_hsi", "ST_spawn_hsi"),
                     LFR_spawn = c("LFR_spawn_hsi", "FR_spawn_hsi", "SR_spawn_hsi", 
                                   "ST_spawn_hsi"),
                     ST_spawn = c("ST_spawn_hsi", "SR_spawn_hsi", "FR_spawn_hsi"),
                     WR_juv = c("WR_juv_hsi", "SR_juv_hsi", "FR_juv_hsi", "WR_fry_hsi",
                                "SR_fry_hsi", "FR_fry_hsi", "ST_juv_hsi", "ST_fry_hsi"),
                     WR_fry = c("WR_fry_hsi", "SR_fry_hsi",  "FR_fry_hsi", "WR_juv_hsi", 
                                "SR_juv_hsi", "FR_juv_hsi", "ST_fry_hsi", "ST_juv_hsi"),
                     SR_juv = c("SR_juv_hsi", "FR_juv_hsi", "SR_fry_hsi",
                                "FR_fry_hsi", "ST_juv_hsi", "ST_fry_hsi"),
                     SR_fry = c("SR_fry_hsi", "FR_fry_hsi", "SR_juv_hsi",
                                "FR_juv_hsi", "ST_fry_hsi", "ST_juv_hsi"),
                     FR_juv = c("FR_juv_hsi", "SR_juv_hsi", "FR_fry_hsi",
                                "SR_fry_hsi", "ST_juv_hsi", "ST_fry_hsi"),
                     FR_fry = c("FR_fry_hsi", "FR_juv_hsi", "SR_fry_hsi",
                                "ST_fry_hsi", "SR_juv_hsi", "ST_juv_hsi"),
                     LFR_juv = c("LFR_juv_hsi", "FR_juv_hsi", "SR_juv_hsi", 
                                 "FR_fry_hsi", "SR_fry_hsi", "ST_juv_hsi", "ST_fry_hsi"),
                     LFR_fry = c("LFR_fry_hsi", "FR_fry_hsi", "FR_juv_hsi", 
                                 "SR_fry_hsi", "ST_fry_hsi", "SR_juv_hsi", "ST_juv_hsi"),
                     ST_adult = c("ST_adult_hsi"),
                     ST_juv = c("ST_juv_hsi", "ST_fry_hsi", "SR_juv_hsi",
                                "SR_fry_hsi", "FR_juv_hsi", "FR_fry_hsi"),
                     ST_fry = c("ST_fry_hsi", "ST_juv_hsi", "SR_fry_hsi",
                                "SR_juv_hsi", "FR_fry_hsi", "FR_juv_hsi"))
  }
